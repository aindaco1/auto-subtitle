# Legacy CLI (0.2 workflow)

This workflow is retained for compatibility. Prefix the commands below with `auto-subtitle legacy` instead of `auto-subtitle`. It is not used by the macOS app. See the [current README](../README.md).
