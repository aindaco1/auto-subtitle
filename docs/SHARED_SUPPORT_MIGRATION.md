...
Auto Subtitle 1.0.5 advances Platform to `b32a38b34f83daf142bd42d0c8f80ff4220952ad`, Desktop Swift 0.3.0 and Apple Support 0.1.0. Existing diagnostics imports continue through the compatibility facade. The app retains its exact Sparkle pin, report schema, preview, consent, endpoint, storage and error policy.
