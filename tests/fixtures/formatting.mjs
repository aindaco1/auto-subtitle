...
export const fixtures = [
  {id:'english-phrase', language:'en', format:'srt', source:srt(['We should meet outside the old station after the last train.']),
    requirements:{phrase:'Line breaks keep grammatical phrases together; do not detach an article or preposition from the phrase that follows.'}},
  {id:'spanish-phrase', language:'es', format:'srt', source:srt(['Nos vemos en la estación central después del último tren.']),
    requirements:{phrase:'Los saltos de línea mantienen juntas las unidades gramaticales; no separan un artículo o una preposición de su complemento.'}},
  ...
  {id:'names-numbers-negation', language:'en', format:'srt', source:srt(['Do not give Dr. Ana Ruiz more than 1.5 mg at 8:30.']),
    requirements:{name:'The name Dr. Ana Ruiz stays together on one display line.', dose:'The caption forbids giving Dr. Ana Ruiz more than 1.5 mg at 8:30.'}},
